...
const HELP_CONTENT: Record<HelpTopic, HelpContentEntry> = {
  search_terms: {
    title: "Search Terms",
    content:
      "Enter words or phrases to search for. Exact matching is handled automatically.",
  ...
  boolean_operators: {
    title: "Boolean Logic",
    content:
      "Use AND to require all terms, OR for any terms. Click NOT to exclude terms.",
    examples: [
  ...
  ai_search: {
    ...
    content:
      "Find words with similar meanings using AI. Click ⭐ to get suggestions.",
  ...
  field_selection: {
    ...
    content:
      "Choose from predefined values for this field. Select multiple values using AND/OR logic.",
  ...
  ner_toggle: {
    ...
    content:
      "Automatically identify and highlight people, places, organizations, and other entities in your text.",
  ...
  word_cloud: {
    ...
    content:
      "Visual representation of word frequency. Larger words appear more often in your results.",
    type: "info",
  },
  statistics: {
    title: "Statistical Analysis",
    content:
      "Get insights about your document collection including word counts, languages, and distributions.",
    type: "info",
  },
  collection_selection: {
    title: "Collection Selection",
    content:
      "Choose which document collection to search. Each collection may have different fields and content types.",
    type: "info",
  },
  field_completeness: {
    title: "Field Completeness",
    content:
      "Shows what percentage of documents have data in each field. Higher percentages mean more reliable results.",
    type: "info",
  },
  query_performance: {
    title: "Search Performance",
    content:
      "More specific searches are faster. Consider adding filters to improve performance on large datasets.",
    type: "warning",
  },
  not_operator: {
    title: "NOT Operator",
    content:
      "Exclude documents containing this term. Red styling indicates exclusion.",
    examples: [
      'NOT climate → excludes "climate"',
  ...
  and_operator: {
    title: "AND Operator",
    content:
      "All connected terms must appear in the document. More restrictive search.",
  ...
  or_operator: {
    title: "OR Operator",
    content:
      "Any of the connected terms can appear in the document. Broader search.",
...
const ContextHelp: React.FC<ContextHelpProps> = ({
  ...
  const getIcon = () => {
    switch (helpInfo.type) {
      case "success":
        return <CheckCircle fontSize={size} color="success" />;
      case "warning":
        return <Warning fontSize={size} color="warning" />;
      case "info":
      default:
        return <Help fontSize={size} color="action" />;
    }
  };
    ...
    <Tooltip title={tooltipContent} arrow placement={placement}>
      <IconButton
        ...
        sx={{
          ...
          "&:hover": {
            color:
              helpInfo.type === "success"
                ? "success.main"
                : helpInfo.type === "warning"
                  ? "warning.main"
                  : "primary.main",
          },
        }}
