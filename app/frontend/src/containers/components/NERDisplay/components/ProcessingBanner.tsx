...
const ProcessingBanner: React.FC<ProcessingBannerProps> = ({
  ...
  const getPhaseDescription = (phase: string) => {
    switch (phase) {
      case "preprocessing":
        return "Cleaning and normalizing entities...";
      case "basic_stats":
        return "Computing basic statistics...";
      case "relationships":
        return "Analyzing entity relationships...";
      case "patterns":
  ...
  const getPhaseIcon = (phase: string) => {
    switch (phase) {
      ...
      case "preprocessing":
        return <CleaningServices color="primary" />;
      default:
    ...
    return (
      <Alert severity="success" sx={{ mb: 3 }}>
        ...
        <Typography variant="body2">
          <strong>Processing Complete:</strong> Applied advanced normalization,
  ...
  if (!isProcessing && stats && !stats.processingComplete) {
    return (
      <Alert severity="info" sx={{ mb: 3 }}>
        ...
        <Typography variant="body2">
          Basic statistics are available now. Advanced features (relationships,
          patterns) are being computed in the background.
        </Typography>
        {!stats.hasAdvancedFeatures && (
          <Typography variant="body2" color="warning.main" sx={{ mt: 1 }}>
            <Warning sx={{ fontSize: 14, mr: 0.5 }} />
            Large dataset detected - some advanced features may be limited for
            performance.
          </Typography>
        )}
      </Alert>
  ...
  return (
    <Alert severity="info" sx={{ mb: 3 }}>
      ...
      <Typography variant="body2">{processingState.currentTask}</Typography>
