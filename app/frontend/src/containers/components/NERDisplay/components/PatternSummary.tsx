      ...
      <CardContent>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={4}>
            <Card variant="outlined" sx={{ textAlign: 'center', border: 2, borderColor: 'primary.light' }}>
              <CardContent>
          ...
          <Grid item xs={12} sm={4}>
            <Card variant="outlined" sx={{ textAlign: 'center', border: 2, borderColor: 'secondary.light' }}>
              <CardContent>
          ...
          <Grid item xs={12} sm={4}>
            <Card variant="outlined" sx={{ textAlign: 'center', border: 2, borderColor: 'success.light' }}>
              <CardContent>
        ...
        <Alert severity="info" sx={{ mt: 2 }}>
          <Typography variant="body2">
            <strong>Quality Assurance:</strong> All patterns exclude repeated entities, filter out noise words (ordinals, cardinals, stop words), 
            use normalized entity names, and require minimum proximity (entities within 500 characters) and frequency (2+ occurrences) thresholds.
          </Typography>
        </Alert>
      </CardContent>
    </Card>
