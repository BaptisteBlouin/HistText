      ...
      <Grid item xs={12}>
        <Alert severity="success" sx={{ mb: 3 }}>
          ...
          <Typography variant="body2">
            ...
            <br />• <strong>Entity Normalization:</strong> "President Biden" +
            "Biden" + "Joe Biden" = "Biden"
            <br />• <strong>Noise Filtering:</strong> Excludes ordinals (1st,
            2nd), cardinals (one, two), common stop words
            <br />• <strong>Proximity Analysis:</strong> Only entities within
            500 characters are considered related
            <br />• <strong>Repetition Exclusion:</strong> Patterns like "Apple
            → Apple → Store" are filtered out
            <br />• <strong>Minimum Frequency:</strong> Only patterns occurring
            2+ times are shown
          </Typography>
        </Alert>
      </Grid>
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Pairs of normalized entities that frequently appear together in
              sequence
            </Typography>
            <PatternList
      ...
      <Grid item xs={12}>
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Four-entity sequences showing complex normalized relationships and
