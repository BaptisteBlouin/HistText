  ...
  const documentStatsData = useMemo(() => {
    ...
    return stats.documentStats
      .map((doc: any, index: number) => ({
        ...
        diversityLevel:
          (doc.uniqueEntityCount / Math.max(doc.entityCount, 1)) * 100 > 80
            ? "High"
            : (doc.uniqueEntityCount / Math.max(doc.entityCount, 1)) * 100 > 60
              ? "Medium"
              : "Low",
      }))
    ...
    <Grid container spacing={3}>
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Click on any point to view the document details. Diversity based
      ...
      <Grid item xs={12} lg={4}>
        <Card>
          <CardContent>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
              <Typography variant="h6">High-Quality Documents</Typography>
              <Chip
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Documents ranked by entity diversity. Click document IDs to view
              details.
            </Typography>
            <List>
                      ...
                      >
                        ...
                        >
                          ...
                          <Chip
                            ...
                            size="small"
                            color={
                              doc.diversityLevel === "High"
                                ? "success"
                                : doc.diversityLevel === "Medium"
                                  ? "warning"
                                  : "error"
                            }
                          />
          ...
          <Card>
            <CardContent>
              ...
              <Alert severity="warning" sx={{ mb: 2 }}>
                Documents with unusual normalized entity patterns that may
                require attention. Analysis based on quality-filtered entities.
              </Alert>
