          ...
          <CardContent>
            ...
            <Alert severity="info" sx={{ mb: 2 }}>
              <Typography variant="body2">
                Distribution after filtering out entities with confidence &lt; 30%
              </Typography>
            </Alert>
      ...
      <Grid item xs={12} lg={6}>
        <Card>
          <CardContent>
            ...
            <Alert severity="info" sx={{ mb: 2 }}>
              <Typography variant="body2">
                Length distribution of normalized entities (after removing prefixes/suffixes)
              </Typography>
            </Alert>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Documents with highest entity diversity (normalized unique entities / total entities). Click document IDs to view details.
            </Typography>
            <Alert severity="info" sx={{ mb: 2 }}>
              <Typography variant="body2">
                Diversity calculated using normalized entities - similar entities like "Apple Inc." and "Apple" count as one unique entity.
              </Typography>
            </Alert>
            <List>
