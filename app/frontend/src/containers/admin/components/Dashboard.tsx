                ...
                <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} sm={6} md={3}>
                        <Paper sx={{ p: 2, textAlign: 'center', bgcolor: analytics.error_rate_percent > 5 ? 'error.light' : 'warning.light', color: analytics.error_rate_percent > 5 ? 'error.contrastText' : 'warning.contrastText' }}>
